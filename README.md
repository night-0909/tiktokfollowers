...
## 2- Export followers/following list of Tiktok accounts id by running get-follows-details.py
...
Example : 
{"accounts": [
	{"id": "6863874874285622278", "steps": {"stepGetFollows": true, "stepGetFollowsDetails": true, "stepConvertJsonToExcel": true}}<br />
],<br />
"scrape": "followers",
...<br />
...
Connect to your Tiktok account and get your "sessionid_ss" and "tt-target-idc" cookies, then set them in get-follows-details.settings.json
